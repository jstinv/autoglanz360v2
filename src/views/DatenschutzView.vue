<template>
  <section class="datenschutz container my-5">
    ...
    <p>
      Telefon: 0174 3664793<br />
      E-Mail: autoglanz360@gmx.de
    </p>

    <h2>3. Erfassung Ihrer Daten</h2>
    <h3>Kontaktformular (Buchungsanfrage)</h3>
    <p>
      Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre Angaben aus dem
      Anfrageformular inklusive der von Ihnen dort angegebenen Kontaktdaten (Name, E-Mail-Adresse,
      Telefonnummer) sowie Fahrzeugdaten zwecks Bearbeitung der Anfrage und für den Fall von
    ...
    <p>
      ...
      Löschung auffordern oder der Zweck für die Datenspeicherung entfällt (z. B. nach
      abgeschlossener Bearbeitung Ihrer Anfrage). Zwingende gesetzliche Bestimmungen – insbesondere
      Aufbewahrungsfristen – bleiben unberührt.
    </p>

    <h3>E-Mail-Versand via EmailJS</h3>
    <p>
      Für den Versand der Buchungsanfragen über unser Formular nutzen wir den Dienst „EmailJS“.
      Anbieter ist die EmailJS (San Francisco, USA). EmailJS ist ein Dienst, mit dem der Versand von
      transaktionalen E-Mails organisiert und analysiert werden kann. Die von Ihnen im Formular
      eingegebenen Daten werden zur Übermittlung an uns an die Server von EmailJS in den USA
      übertragen.
    </p>
    <p>
      Die Datenverarbeitung erfolgt auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO),
      die Sie durch das Absenden des Formulars erteilen. Sie können diese Einwilligung jederzeit
      widerrufen. Die Rechtmäßigkeit der bereits erfolgten Datenverarbeitungsvorgänge bleibt vom
      Widerruf unberührt.
    </p>
    <p>
      Nähere Informationen finden Sie in der Datenschutzerklärung von EmailJS unter:
